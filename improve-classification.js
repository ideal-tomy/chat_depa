...
fs.writeFileSync('improved-reclassified-bots.json', JSON.stringify(outputData, null, 2));
console.log('\n結果を improved-reclassified-bots.json に保存しました。'); 